    ...
    addListItem: (obj, type) => {
      ...
      if (type === "inc") {
        ...
        newHTML = `<div class="item " id="inc-${
          ...
          obj.value,
          type
        )}</div><div class="item__delete"><button class="item__delete--btn"><i class="ion-ios-close"></i></button></div></div></div>`;
      } else if (type === "exp") {
        element = DOMstrings.expensesContainer;

        newHTML = `<div class="item " id="exp-${
          obj.id
        }"><div class="item__description">${
          obj.description
        }</div><div class="right "><div class="item__value">${formatNumber(
          obj.value,
          type
        )}</div><div class="item__percentage">45%</div><div class="item__delete"><button class="item__delete--btn"><i class="ion-ios-close"></i></button></div></div></div>`;
      }
